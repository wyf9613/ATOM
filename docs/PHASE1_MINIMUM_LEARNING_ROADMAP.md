...
机械臂已于 2026-08-29 确认为到货的 UFactory xArm 850，但控制器、固件和厂商支持矩阵尚未完成清点。因此本文仍不把某个 Ubuntu、ROS 2、Gazebo、驱动或 MoveIt 版本写成已经确定的项目事实。正式安装前应：

1. 清点 xArm 850 控制器与固件，并确认厂商 ROS 2 驱动支持范围；
